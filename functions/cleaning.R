...
#Libraries ----
library(dplyr)      # For data manipulation (mutate, select, rename_with, across, glimpse)
library(stringr)    # For string manipulation (str_trim, str_squish, str_replace_all, str_to_lower)
library(janitor)    # For clean_names() function
library(lubridate)  # For date conversion (dmy)
