...
# Settlement gravity × connectivity interaction
...
print(make_aicc_df(list(
  "Baseline + SG"            = b_q1_settgrav,
  "Baseline + SG + conn"     = b_sens_sg_conn,
  "Baseline + SG + conn + int" = b_sens_sg_conn_int
)))

summary(b_sens_sg_conn_int)
confint(b_sens_sg_conn_int)
...
# Market gravity × connectivity interaction
...
print(make_aicc_df(list(
  "Baseline + MG"              = b_q1_mktgrav,
  "Baseline + MG + conn"       = b_sens_mg_conn,
  "Baseline + MG + conn + int" = b_sens_mg_conn_int
)))

summary(b_sens_mg_conn_int)
confint(b_sens_mg_conn_int)
